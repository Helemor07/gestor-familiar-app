...
if 'usuario_actual' not in st.session_state:
    st.session_state.usuario_actual = None #"None" significa que nadie ha entrado aún
...
if st.session_state.usuario_actual is None:
    ...
    if st.button("Entrar"):
        if usuario_seleccionado != "Selecciona...":
            ...
            st.rerun() # Corregido rerurn por rerun
        else:
...
#----------------------------------------------------------------------
    ...
    # ¡Todo lo de abajo ahora tiene un tabulador más para pertenecer al "else"!
    #----------------------------------------------------------------------
